    ...
    <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200">
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="flex-1">
          <label htmlFor="weapon-search" className="block text-sm font-medium text-gray-700 mb-2">
        ...
        <div className="lg:w-48">
          <label htmlFor="weapon-type" className="block text-sm font-medium text-gray-700 mb-2">
        ...
        {/* Rarity Filter */}
        <div className="lg:w-48">
          <label htmlFor="weapon-rarity" className="block text-sm font-medium text-gray-700 mb-2">
        ...
        <div className="lg:w-auto flex items-end">
          <button
            ...
            className="w-full lg:w-auto px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 border border-gray-300 rounded-lg hover:bg-gray-200:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
          >
